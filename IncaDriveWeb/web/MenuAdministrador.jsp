...
<%@page import="Controlador.ControladorAuto"%>
<!DOCTYPE html>
        ...
        <div class="container">
            ...
            <aside>
                ...
                <div class="sidebar">
                    ...
                    <a href="ControladorAuto?Op=Listar">
                        <span class="material-icons-sharp">
                            inventory_2
                        </span>
                        <h3>Autos</h3>
            ...
            <main>
                ...
                <div class="new-users">
                    ...
                    <div class="user-list">
                        ...
                        <div class="user">
                            <img src="resources/images/productos/AUT006.png" alt=""/>
                            <h2>MAZDA</h2>
                            <p>3 unidades</p>
                        </div>
                        <div class="user">
                            <img src="resources/images/productos/AUT007.png" alt=""/>
                            <h2>HONDA</h2>
                            <p>6 unidades</p>
                        </div>
                        <div class="user">

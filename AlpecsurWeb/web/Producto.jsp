...
<html>
    ...
    <body>
        <div id="btnAgregarContainer">
            <input type="button" value="Agregar Producto" class="btn btn-info" id="btnAgregar" data-toggle="modal" data-target="#agregarProductoModal">
        </div>
            ...
            <div class="col-sm-12">
                <table class="table table-hover" border="1" style="border-radius:20px; margin-top:15px;">
                    ...
                    <tbody>
                        ...
                        <td><center>${producto.getCategoria().getNombre()}</center></td> <!-- Accede al nombre de la categoría a través del objeto Categoria asociado -->
                        <td><center>${producto.getPrecio()}</center></td>
                        <td><center>${producto.getStock()}</center></td>
                        <td><center>${producto.getMarca().getNombre()}</center></td> <!-- Accede al nombre de la marca a través del objeto Marca asociado -->
